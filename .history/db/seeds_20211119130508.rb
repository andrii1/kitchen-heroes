...
booking1 = Booking.new(content: 'This chef has done an amazing job on our birthday party! The food was delicious and everyone was very happy')
booking2 = Booking.new(content: 'OK chef for a good price')
booking3 = Booking.new(content: 'An outstanding chef. I would recommend for everyone - either for a small or big event. Service was also really good!')
